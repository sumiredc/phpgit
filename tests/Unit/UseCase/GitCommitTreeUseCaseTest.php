...
describe('__invoke', function () {
    it(
        ...
        function (string $object, string $message, ObjectHash $commitHash, string $expected) {
        ...
        ->with([
            [
                'object' => '04ba9ed331f1eaa7618aefb1db4da5988463404d',
    ...
    it(
        ...
        function (string $object, string $expected) {
            ...
            $useCase = new GitCommitTreeUseCase($this->io, $this->gitConfigRepository, $this->objectRepository);
            $actual = $useCase($object, 'dummy message');
    ...
    it(
        ...
        function (string $object, GitObject $gitObject, string $expected) {
            $this->objectRepository->shouldReceive('exists')->andReturn(true)->once();
    ...
    it(
        ...
        function (Throwable $th, Throwable $expected) {
            ...
            $useCase = new GitCommitTreeUseCase($this->io, $this->gitConfigRepository, $this->objectRepository);
            $actual = $useCase('04ba9ed331f1eaa7618aefb1db4da5988463404d', 'dummy message');

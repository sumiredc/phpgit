...
describe('new', function () {
    it(
        ...
        function (string $object, GitCatFileOptionType $expected) {
            ...
            $actual = GitCatFileRequest::new($this->input);
        ...
        ->with([
            ['7325eb186677325ce158c51f203f3d026e48803b', GitCatFileOptionType::Type]
        ]);
    ...
    it(
        ...
        ->with([
            ['235dfc9ddd37a18f1f6638d80e146252020cb4a8', GitCatFileOptionType::Size]
        ]);
    ...
    it(
        ...
        ->with([
            ['34a2d4555e37ca2ad68563f0ce17d327b8bc0301', GitCatFileOptionType::Exists]
        ]);
    ...
    it(
        ...
        ->with([
            ['726c09f30127b66229f7d091ae51396060a3cdeb', GitCatFileOptionType::PrettyPrint]
        ]);
    ...
    it(
        ...
        function (Throwable $expected) {
            ...
            expect(fn() => GitCatFileRequest::new($this->input))->toThrow($expected);
        }
    )
        ->with([
